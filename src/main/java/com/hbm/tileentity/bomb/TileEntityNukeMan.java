...
public class TileEntityNukeMan extends TileEntity implements ISidedInventory, IGUIProvider {
	...
	public boolean isReady() {
		...
		{
            return this.slots[0] != null && this.slots[5] != null && this.slots[0].getItem() == ModItems.man_igniter && slots[5].getItem() == ModItems.man_core;
		}
