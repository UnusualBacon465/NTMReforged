...
import static com.hbm.items.machine.ItemScraps.getMats;
import static com.hbm.util.ItemStackUtil.getOreDictNames;
...
public class Mats {
    ...
    public static List<MaterialStack> getMaterialsFromItem(ItemStack stack) {
        ...
        List<MaterialStack> entries = materialEntries.get(new ComparableStack(stack.getItem()).makeSingular());
